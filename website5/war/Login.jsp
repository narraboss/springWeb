...
<body>
			...
			<li>
				<%
					if (session.getAttribute("login").toString() == "0" || session.getAttribute("login") == "") {
						if (Integer.parseInt(session.getAttribute("loginAttempt").toString()) < 2
								|| session.getAttribute("loginAttempt").toString() == "") {
				%>
 ...
 %> <a href="afterlogin.html" target="_top"><h2>Go To Menu</h2></a><br>
				<br>
