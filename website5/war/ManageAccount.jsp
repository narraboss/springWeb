							...
							<table class="table-striped" align="center">
								...
								<%
									...
									for (Customer c : customers) {
										...
										if (c.getCustomerId().equals((String) session.getAttribute("customerId"))) {
											a = c;
										}
									}
								%>
								...
								<tr>
									<td class="bg-warning" id="phoneno1"
										style="visibility: hidden;">New Mobile no</td>
								...
								<tr>
									<td class="bg-warning" id="address1"
										style="visibility: hidden;">New Address</td>
								...
								<tr>
									...
									<td class="bg-warning" id="email1" style="visibility: hidden;">New
										Mail Id</td>
