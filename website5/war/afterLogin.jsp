...
<body>
	...
	<h3 style="font-size: 30px; color: #488ac7;">
		...
		<div class="container ">
			<div>
				<div class="intro-lead-in text-center">Welcome To Our Bank!</div>
				<br />
				<div class="intro-heading text-center">Nice To Meet You</div>
				<br />
				<br />
				<br />
			</div>
			...
			<div style="border-styl border-width: 55px; border-color: #FFFFFF;">
				...
				<table class="table" style="border-spacing: 4px;">
					...
					<tr>
						...
						<th><label><%=(String) session.getAttribute("customerName")%></label></th>
