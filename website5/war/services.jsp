...
<td colspan="2"><input type="submit" value="Submit"/></td>		
	...
	<!-- /.container-fluid --> </nav>
	<div class="well">
		<h3 class="title  text-center">Services we provide</h3>

		<p>Business Bank provides you a secure 24X7-access internet
			Banking that provides you access to your accounts.Within internet
			banking, you can take charge of all your accounts from the
			convenience of your own home.</p>

		<p>Business Bank wishes to provide round the clock services to its
			customers not only in the banking hours but also during public
		...
		<p>Further, we would like to enure that users can perform banking
			...
			other words mobile banking.Our bank would allow customers to carry
			out core banking operations as listed below:</p>
