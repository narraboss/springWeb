...
public class TransactionSelect extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
		...
		if ((session.getAttribute("login").toString()).equals("1")) {
			...
			out.println("<html>");
			out.println("<body style=\"border-style:solid;" + "border-width: 55px;" + "border-color:#FFFFFF;\">");
			...
			out.println("<table style=\"border-spacing:4px;\"><tr>"
					...
					+ "PADDING-BOTTOM: 10px; PADDING-TOP: 10px;" + "background-color:#EBF0FF;color:#1975D1;\""
					+ "><label>Account Number</label></th>" + "<th style=\"PADDING-RIGHT: 10px; PADDING-LEFT: 10px;"
					+ "PADDING-BOTTOM: 10px; PADDING-TOP: 10px;" + "background-color:#EBF0FF;color:#1975D1;\""
					+ "><label>Name</label></th>" + "<th style=\"PADDING-RIGHT: 10px; PADDING-LEFT: 10px;"
					+ "PADDING-BOTTOM: 10px; PADDING-TOP: 10px;" + "background-color:#EBF0FF;color:#1975D1;\""
					+ "><label>Balance</label></th>" + "<th style=\"PADDING-RIGHT: 10px; PADDING-LEFT: 10px;"
					+ "PADDING-BOTTOM: 10px; PADDING-TOP: 10px;" + "background-color:#EBF0FF;color:#1975D1;\""
			...
			for (Account acc : a) {
				if ((acc.getCustomerId()).equals((session.getAttribute("customerId")).toString())) {
					out.println("<tr><td style=\"PADDING-RIGHT: 10px; PADDING-LEFT: 10px;"
							...
							+ "<td style=\"PADDING-RIGHT: 10px; PADDING-LEFT: 10px;"
							+ "PADDING-BOTTOM: 10px; PADDING-TOP: 10px;" + "background-color:#EBF0FF;color:#1975D1;\""
							+ ">" + acc.getBalance() + "</td>" + "<td style=\"PADDING-RIGHT: 10px; PADDING-LEFT: 10px;"
							+ "PADDING-BOTTOM: 10px; PADDING-TOP: 10px;" + "background-color:#EBF0FF;color:#1975D1;\""
