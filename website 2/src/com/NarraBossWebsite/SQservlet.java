...
public class SQservlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
		    ...
		    if(a.equals(answer)){
		    	match=1;
		    	loginservlet.login=1;
		    	//session.setAttribute("login","1");
		    	List<Customer> customers=CustomerDao.INSTANCE.listCustomers();
		    	loginservlet.loginAttempt=1;
		    	
		    	//session.setAttribute("loginAttempt","1");
		    	for(Customer c:customers)
   					if(loginservlet.customerId.equals(c.getCustomerId()))
   						loginservlet.customerName= c.getName();
