			...
			<div class="loginmodal-container">
				...
				<form name="login" method="get" action="/login">
					<table>
						...
						<tr>
							<td class="status" colspan="2" name="cidstatus" id="cidstatus"></td>
						</tr>
						...
						<tr>
							<td class="status" colspan="2" name="pwdstatus" id="pwdstatus"></td>
						</tr>
		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown"><a href="#" data-toggle="dropdown"
					...
					hover="dropdown">HOME </a></li>
				<li class="dropdown"><a href="#" data-toggle="dropdown"
					role="button" aria-haspopup="true" aria-expanded="false"
					hover="dropdown">About Us </a></li>
				<li class="dropdown"><a href="#" data-toggle="dropdown"
					role="button" aria-haspopup="true" aria-expanded="false"
					hover="dropdown">Services</a></li>
				<li class="dropdown"><a href="#" data-toggle="dropdown"
					role="button" aria-haspopup="true" aria-expanded="false"
					hover="dropdown">Contact Us </a></li>
			</ul>
	...
	<div class="well">
		...
		<div class="entry">
			...
			<dl>
				...
				<dt>Get information on location of Bank branch and or ATMs</dt>
